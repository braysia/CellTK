...
op000 = dict(function='flatfield_references', inputdir='data/KTRimages/LMB/Pos005/*DAPI*', ff_paths="data/KTRimages/LMB/FF/*DAPI*", exp_corr=True, output_folder='DAPI')
op001 = dict(function='flalstfield_references', inputdir='data/KTRimages/LMB/Pos005/*YFP*', ff_paths="data/KTRimages/LMB/FF/*YFP*", output_folder='YFP')
...
op004 = dict(function='adaptive_thres', FIL1=20, R1=300)

op005 = dict(function='propagate_multisnakes', NITER=20, lambda2=3, inputdir='DAPI')
...
op009 = dict(function='ring_dilation_above_offset_buffer', OFFSET=200, inputdir='YFP', output_folder='cyto')
